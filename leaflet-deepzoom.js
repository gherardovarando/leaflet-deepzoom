...
L.TileLayer.DeepZoom = L.TileLayer.extend({
  ...
  onAdd: function(map) {
    var maxZoomGrid = this._gridSize[this.options.maxNativeZoom];
    var southWest = map.unproject([0, this.options.height], this.options.maxNativeZoom);
    var northEast = map.unproject([this.options.width, 0], this.options.maxNativeZoom);
